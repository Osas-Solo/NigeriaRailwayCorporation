                            ...
                            <div class="tm-bg-white tm-p-4">
                                ...
                                <div class="table-responsive mx-auto">
                                    <table class="table table-striped">
                                        <h2 class="caption-top text-center mt-4">Personal Details</h2>
                                        <tbody>
                                            <tr>
                                                <th>Username</th>
                                ...
                                <div class="text-center font-weight-bold">
                                    <a href="index.php">Book Reservation</a>
                                </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $reservation->bus->route->station?></td>
                                                <td><?php echo $reservation->bus->route->destination?></td>
                                                <td><?php echo convert_date_to_readable_form($reservation->journey_date)?></td>
                                                <td><?php echo $reservation->journey_time?></td>
                                            </tr>
