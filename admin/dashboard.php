...
$passengers = Passenger::get_passengers($database_connection);

$reservations = Reservation::get_reservations($database_connection);
                            ...
                            <div class="tm-bg-white tm-p-4">
                                ...
                                <div class="table-responsive mx-auto">
                                    <table class="table table-striped">
                                        <h2 class="caption-top text-center mt-4">Passengers</h2>
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <a href = "view-passenger.php?username=<?php echo $passenger->username?>">
                                                        <?php echo $passenger->username?>
                                                    </a>
                                                </td>
                                                <td class="text-center"><?php echo $passenger->get_full_name()?></td>
                                            </tr>
